...
#define _cGSLVector_H_
		...
		class cGSLMatrix ;
			...
			*/	
			...
			public :
				...
				void ReAlloc(gsl_vector* theVect) ;///< Reallocation and initialisation of mVect
				void Set(double theValue, int theIndex);
				...
				friend bool IsNaN(const cGSLVector& theVect);
#endif // _MSC_VER
				} ; // class
#ifndef _MSC_VER
	...
	extern bool IsNaN(const cGSLVector& theVect);
