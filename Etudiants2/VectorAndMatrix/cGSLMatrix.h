	...
	namespace VectorAndMatrixNameSpace
	{
			...
			*/	
			...
			public :
				...
				void Set(double theValue, int theRow, int theCol);
...
/*
				...
				friend cGSLMatrix Diag(cGSLVector& theVect) ;
				friend cGSLMatrix Diag( cGSLMatrix& theMat);
				...
				friend cGSLMatrix Inv(const cGSLMatrix &theMatrix, int& theError);
...
//	#ifndef _MSC_VER
		...
		extern cGSLMatrix Inv(const cGSLMatrix &theMatrix, int& theError);
		...
		extern bool IsNaN(const cGSLMatrix& theMatrix);
//	#endif // _MSC_VER
	} // namespace
